...
#***   Verify sign in with more than max length for Email Id(130 characters)  ***#
...
class SignInTest(unittest.TestCase,Base,SignInPage):
    ...
    def test_signin(self):
            ...
            spobj.clickSignIn()
            spobj.setEmailAddress(bobj.readExcel("Sign_In_Test_Data",4,2))
            spobj.setPassword(bobj.readExcel("Sign_In_Test_Data",4,3))
            spobj.clickPopUpSignIn()
            spobj.verifyUnRegisteredAccount()
