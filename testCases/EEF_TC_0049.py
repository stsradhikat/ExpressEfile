...
#***   Verify sign in with already exisiting Google ID  ***#
...
class SignInTest(unittest.TestCase,Base,SignInPage):
    ...
    def test_signin(self):
            ...
            spobj.clickSignIn()
            spobj.setEmailAddress(bobj.readExcel("Sign_In_Test_Data",2,2))
            spobj.setPassword(bobj.readExcel("Sign_In_Test_Data",2,3))
            spobj.clickPopUpSignIn()
            spobj.verifyGoogleSignInAccount()
