...
#***   Verify sign in with  email id (Missing .(dot))  ***#
...
class SignInTest(unittest.TestCase,Base,SignInPage):
    ...
    def test_signin(self):
            ...
            spobj.clickSignIn()
            spobj.setEmailAddress(bobj.readExcel("Sign_In_Test_Data",6,2))
            spobj.setPassword(bobj.readExcel("Sign_In_Test_Data",6,3))
