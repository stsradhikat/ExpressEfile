...
#***   Verify sign in with  invalid email id (Missing @)  ***#
...
class SignInTest(unittest.TestCase,Base,SignInPage):
    ...
    def test_signin(self):
            ...
            spobj.clickSignIn()
            spobj.setEmailAddress(bobj.readExcel("Sign_In_Test_Data",5,2))
            spobj.setPassword(bobj.readExcel("Sign_In_Test_Data",5,3))
